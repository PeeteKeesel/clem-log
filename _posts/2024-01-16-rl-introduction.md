...
It is interesting to investigate the distribution of occurences of each action $a$ over a whole episode. 



Additonally we can look at the reward distribution per action.
